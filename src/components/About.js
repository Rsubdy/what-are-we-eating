...
function About() {
  return (
    <div>
      ...
      <ul>
<li>The app is entirely build in **React.js** and utilizes **React Router** for routing and **Redux** for state management.</li>
...
<li>The styling is applied with the **Bootstrap** library.</li>
<li>The logo was designed by prompting **Chat GPT**.</li>
</ul>
    </div>
  )
}
